...
VERSION = "1.0"  # TODO: Update to dynamic versioning from package
...
def parse_args():
    ...
    parser.add_argument("--t1ir", nargs="?", help="Specify the filename of ")
...
def main():
    ...
    # plot_result(const_dict, pars_dict, data_dict)
